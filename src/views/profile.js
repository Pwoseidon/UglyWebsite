    ...
    <div className="profile-container">
      ...
      <div className="profile-profile">
        ...
        >
          <img
            alt="image"
            src="/playground_assets/nftdaoo-500h.png"
        ...
        <div className="profile-container01">
          ...
          >
            <h1 className="profile-link2">Pwoseidon.eth</h1>
          </a>
          <span className="profile-text">
            <span className="medium">
              Pwoseidon is a web3 musician, an interoperability maximalist, and
              proudly a Frog of the Omnipond.
            </span>
            <br></br>
            <br></br>
            <br></br>
      ...
      <div className="profile-blog-posts">
        <h1 className="profile-text06 headingTwo">
          <span></span>
          ...
          <div className="profile-container05">
            <div className="profile-card">
              <div className="profile-container06">
                <h1 className="profile-text09">Flexible work hours</h1>
                ...
                <div className="profile-container07">
                  <button className="profile-button button">
                    <span className="profile-text12">Read more</span>
      ...
      <div className="profile-contact">
        <div className="profile-container09">
          <div className="profile-form">
            <h2 className="profile-text13 headingOne">
              <span>Say Hi!</span>
            </h2>
            <span className="profile-text15 lead">
              We&apos;d like to talk with you.
            </span>
            <form className="profile-form1">
              <label className="profile-text16 label">My name is</label>
              <input
                type="text"
                placeholder="Full Name"
                className="profile-textinput small input"
              />
              <label className="profile-text17 label">
                I&apos;m looking for
              </label>
              <input
                type="text"
              ...
              />
              <label className="profile-text18 label">Your message</label>
              <textarea
                rows="8"
            ...
            <div className="profile-container12">
              ...
              <div className="profile-container13">
                <div className="profile-container14">
                  ...
                  <a href="tel:+40 772 100 200" className="profile-link3 small">
                    (+40) 772 100 200
                  </a>
                </div>
